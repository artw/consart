...
# add to PATH 
foreach dir (/usr/sbin /usr/local/sbin $HOME/Applications/android-sdk-mac_86/tools $HOME/android-sdk-mac_86/platform-tools /usr/local/kde4 /opt/local/bin /opt/local/sbin)
   if [[ -d $dir ]]; then
