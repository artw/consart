hi x000_Black             ctermfg=0   guifg=#000000
hi x001_Red               ctermfg=1   guifg=#800000
hi x002_Green             ctermfg=2   guifg=#008000
hi x003_Yellow            ctermfg=3   guifg=#808000
hi x004_Blue              ctermfg=4   guifg=#000080
hi x005_Purple            ctermfg=5   guifg=#800080
hi x006_Cyan              ctermfg=6   guifg=#008080
hi x007_Grey              ctermfg=7   guifg=#c0c0c0
hi x008_DarkGrey          ctermfg=8   guifg=#808080
hi x009_LightRed          ctermfg=9   guifg=#ff0000
hi x010_LightGreen        ctermfg=10  guifg=#00ff00
hi x011_LightYellow       ctermfg=11  guifg=#ffff00
hi x012_LightBlue         ctermfg=12  guifg=#0000ff
hi x013_Pink              ctermfg=13  guifg=#ff00ff
hi x014_LightCyan         ctermfg=14  guifg=#008080
hi x015_White             ctermfg=15  guifg=#00ffff
