...
/* appearance */
static const char font[]            = "-*-terminus-*-*-*-*-12-*-*-*-*-*-koi8-*";
...
static const Tag tags[] = {
	...
	{ "1", &layouts[0], -1,    -1,      -1,     -1,         -1 },
	{ "2", &layouts[0], -1,    -1,      -1,     -1,         -1 },
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-b", "-i", "-fn", font, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
